...
const primerCasoComponente = (item)=>{
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12 text-center">
            ...
            <div>
                <div id="container-title-btn" class="container-mainly-btn">
                    <button type="button" class="btn btn-outline-secondary btn-sm btns-components-action-lx" id="button-component-AgregarDoc${j}" onclick="agregarFormularioExistente(this,'${idCurriculumFormacion}' )"><i class="fas fa-plus"></i> Agregar archivos</button>
                </div>
            </div>
        </div>
    </div>`;
...
const showInfoafterEdicion = (item)=>{
    return `<div class="form-row text-center">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <a target="_blank" href="/prospecto/documentoFormacionObtener/${item.idDocumento}">${item.archivo}</a>
                        </div>
                </div>`;
}
...
const showcargaFormacionAcademicaDOCS = async () => {
    ...
    let datosDeInicio = await  getDataFromServerHidden('documentosObtenidosGral','GET');
...
*/
    let datosFormaciones = await getDataFromServerHidden('formacionAcademica','GET',);
