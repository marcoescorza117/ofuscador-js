    ...
    try {
        ...
        return `
            ...
            <div class="form-group col-md-4">
                <h6>Evidencia:</h6>
                <div>
                    <a target="_blank" title="${documentoIndividual.tipoDocumento}" href="/prospecto/documentoFormacionObtener/${documentoIndividual.idDocumento}">${documentoIndividual.archivo}</a>
                </div>
            </div>`;
    }catch (e){
...
const agregarNuevoElementoFormacionLaboral = (params) => {

    //Buscando elemento origen....
    let j = Math.floor(Math.random() * 100000);

    //let data = "<p><ul><li>Hola Mundoo</li><li>hoashooashdahosda</li><li>dsadsadasdas</li><li>das</li><li>d</li><li>asd</li><li>sa</li><li>dasdasdasdsahjdashdjaskhdasjkhdsajkhdjaskdsajkdhas&nbsp; dhsajdhasjkdshadhasdjksa</li></ul></p>"
    //let data = "\"<p>hdhaskdhsajkdjhsakhdasd</p><p><ul><li>dsadasdasds</li><li>dsadsadasda</li></ul><ol><li><span style=\"font-size: 0.9rem;\">dasdasdadasdasdasdasdasdasda</span></li></ol><p>dasdasdasdas</p><p><br></p><p><br></p><p><ol><li>dasdasdasd</li><li>dasdasdas</li><li>das</li></ol><p>dasdasdasdasd</p></p></p>\"";
    //let someText = data.replace(/(\r\\n|\\n|\\r|\\")/gm, "");
    //$("#FormacionLaboralContainer").prepend(someText.trim())



    let contendorePadre = document.getElementById('FormacionLaboralContainer');

    console.log(contendorePadre.children.length)
    if (contendorePadre.children.length<3){
        //$("#FormacionLaboralContainer").prepend(componenteInicialBaseFormacionLaboral(j))
        $("#FormacionLaboralContainer").prepend(componenteInicialBaseFormacionLaboral(j))
    }else{

        swal({
            title : 'Atención',
            text: 'Solo se permiten los últimos 3 empleos a la fecha actual.',
            type: 'warning'
        });
        ...
        <div class="card  card-formacion-academica card-formacion-FormacionLaboral" id="card-formacion-FormacionLaboral">
            <div class="card-header">
                ...
                <div class="card-buttons">
                        ...
                        ${btnsComponentEditaFirstFormacionLaboralMOSTRAR(itemFormacion)}
...
async function mostrarFormulariosFormacionLaboral(){
    ...
    let data = await getDataFromServerHidden('getListadoFormacionLaboral','GET');
...
const showFormacionesLABORALes = async ()=>{
    ...
    visibilityComponent('titlegralOptionsFormacionLaboral1', false)
