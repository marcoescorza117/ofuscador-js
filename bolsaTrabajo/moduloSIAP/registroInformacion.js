...
function _ROUTESOBJTS()
{


    let itemRouteDocFormacionGral = document.getElementById('RouteDocFormacion').value;
    let itemRouteDocPersonalesGral = document.getElementById('RouteDocPersonales').value;
    let itemRouteDocParientesGral = document.getElementById('RouteDocParientes').value;

    let objectDataRoutes ={
         itemRouteDocFormacionGral: itemRouteDocFormacionGral
        ,itemRouteDocPersonalesGral: itemRouteDocPersonalesGral
        ,itemRouteDocParientesGral: itemRouteDocParientesGral
    }

    return {
        getITEMSROUTE: ()=>{
            return objectDataRoutes
        }
    }
}
