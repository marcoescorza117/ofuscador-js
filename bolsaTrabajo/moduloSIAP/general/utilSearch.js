...
const consultarElementos = async ()=> {
    ...
    if (segundaSeccion===true || terceraParte===true){
        ...
        //hay que realizar la correspondiente escritura
    ...
    if (loosUnicos.length>0){
        ...
        if (segunda.pais  === " " && tercero.nivelEstudio === " " && cuarto.distincionCientifica === " " && quinto.idioma === " "){
            ...
            dataaa.forEach((item)=>{
                ...
                stringGenerator+= `
                <tr>
                    <td class="sorting_1"><div class="btn-group mr-2"><a title="Ver detalles" class="btn btn-secondary boton" href="/reclutamientoGeneral/obtenerPersonaAvanzado/${item.idPersona}"><i class="fas fa-id-card"></i>   </a></div></td>
...
//Si se pretende dejar la opcion como se tiene en distincion e idiomas(Abierto )
//Se puede romper la segunda condicion CUIDADO...!
...
const validarCuartaParte = () => {
    ...
    console.log(distincionCIentifica)
...
const validatorFinal =(usuario)=>{
    ...
    if (usuario === undefined ){
        ...
        if (comprobadorGet){
            ...
            return `<tr>
                    <td class="sorting_1"><div class="btn-group mr-2"><a title="Ver detalles" class="btn btn-secondary boton" href="/reclutamientoGeneral/obtenerPersonaAvanzado/${usuario.idPersona}"><i class="fas fa-id-card"></i>   </a></div></td>
