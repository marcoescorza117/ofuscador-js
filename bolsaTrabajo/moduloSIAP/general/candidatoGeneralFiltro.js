...
//Page search
async function busquedaPerfilesGral(){
    ...
    let id = await $.ajax({
        type: 'GET',
        url:'/reclutamientoGeneral/busquedaPerfilGral',
        data:{
            _token: $('meta[name="csrf-token"]').attr("content"),
            ...
            data.forEach((item)=>{
                values +=
                    `<tr>
                        <td class="sorting_1"><div class="btn-group mr-2"><a title="Ver detalles" class="btn btn-secondary boton" href="/reclutamientoGeneral/detalleProspecto/${item.idPersona}"><i class="fas fa-id-card"></i>   </a></div></td>
