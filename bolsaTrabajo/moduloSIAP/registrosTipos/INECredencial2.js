    ...
    <div>
        <div class="form-row" >
            <div class="form-group col-md-3">
                ...
                <input type="text" maxlength="14" class="form-control" name="electorClave" id="electorClave" oninput="eliminarEspacios(this)" autocomplete="off" placeholder="Clave">
            </div>

            <div class="form-group col-md-3">
                <h6>Folio:</h6>
                <input type="text" maxlength="14" class="form-control" name="folioNumero" id="folioNumero" oninput="eliminarEspacios(this)" autocomplete="off" placeholder="Folio">
            </div>

            <div class="form-group col-md-3">
                <h6>Número de credencial (OCR):</h6>
                <input type="text" maxlength="14" class="form-control" name="credencialNumero" id="credencialNumero" oninput="eliminarEspacios(this)" autocomplete="off" placeholder="Número de credencial">
            </div>

            <div class="form-group col-md-3">
                <h6>Fecha de vigencia:</h6>
                <input type="text" maxlength="4" class="form-control" name="vigenciaAnio" id="vigenciaAnio" oninput="eliminarEspacios(this)" autocomplete="off" placeholder="Año">
            </div>
        </div>
...
const agregarFormacionCredencials = () =>{
    $("#section-dataCredencial-info").prepend("<h6 class='text-muted'> * Sin registro</h6>")
}
...
const generateSelectTownINE = async (itemSelected, element) => {
    ...
    if (getMunicipiosEstado.length > 2) {
        getMunicipiosEstado.forEach((item) => {
            selectItem += `<option value="${item.idMunicipio}-${item.clave}">${item.municipio}</option>`;
        })
    } else {
