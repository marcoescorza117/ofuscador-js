...
const setdatosGenerales = (data) =>{
    ...
    let sectionDatos = ` <div class="section-dataInformaciosn" id="section-dataInformaciosn">
                        ...
                        ${obtenerDocumentoCorrespondiente("10")}
                        ${obtenerDocumentoCorrespondiente("15")}
    ...
    let sectionDatos = `<div class="section-nacimiento-info" id="section-nacimiento-info" >
                            ...
                            <div class="form-row text-center">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <p class="text-black-50">Datos no disponibles.</p>
                                </div>
...
const setDatosNacimientoFilled = async (data1, data2, data3, data4) =>{
    ...
    let sectionDatos = `<div class="section-nacimiento-info" id="section-nacimiento-info" >
                        ...
                        <hr>
                        <h6 class="text-black-50 text-center">Documentación:</h6>
                        ${obtenerDocumentoCorrespondiente("2")}
                        ${obtenerDocumentoCorrespondiente("21")}
                        ${obtenerDocumentoCorrespondiente("12")}
                        ${obtenerDocumentoCorrespondiente("14")}
...
const setdatosSegSocial = (data)=>{
    ...
    let sectionDatos = `
                        ...
                        <hr>
                        <h6 class="text-black-50 text-center">Documentación:</h6>
                        ${obtenerDocumentoCorrespondiente("6")}
                        ${obtenerDocumentoCorrespondiente("27")}
...
const componenteDomicilioPrincipalDATA = (item) =>{
    ...
    let data = `<div class="card card-domicilio">
                ...
                <br>
                        ...
                        <hr>
                        <h6 class="text-black-50 text-center">Comprobante de domicilio:</h6>
                        ${obtenerDocumentoCorrespondiente("7")}
                        <hr>
                        <br>
`;
    return data;
