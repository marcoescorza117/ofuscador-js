...
async function sendDataInvitation(element) {
    let id = await $.ajax({
        type: "POST",
        url: "/reclutamientoProfesorHoras/enviarInvitacionHonorario",
        data: {
...
async function returnID2(element, element2) {
    let id = await $.ajax({
        type: "POST",
        url: "/reclutamientoProfesorHoras/idVerificationHonorario",
        data: {
            _token: $('meta[name="csrf-token"]').attr("content"),
            name: element.name,
            firstName: element.firstName,
...
async function busquedaPerfilesHO(){
    ...
    let id = await $.ajax({
        type: 'POST',
        url:'/reclutamientoProfesorHoras/busquedaPerfiHo',
        data:{
            _token: $('meta[name="csrf-token"]').attr("content"),
