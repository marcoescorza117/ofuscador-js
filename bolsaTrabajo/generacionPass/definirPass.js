...
function cloneDataForm() {
    ...
    let [pass1, pass2, pass3, pass4, pass5] = arrayObje;
    let data = new constructorValues(pass2, pass3, pass4, pass5);
    return JSON.stringify(data);
}

function constructorValues(idPass1, idPass2, idPass3, idPass4) {
    this.idPass1 = idPass1;
    this.idPass2 = idPass2;
    this.idPass3 = idPass3;
    this.idPass4 = idPass4;
}
        ...
        swal(
            {
                ...
                text:
                    "Se ha definido la nueva contraseña, será redirigido al sitio e ingresará el usuario y la contraseña definida, " +
